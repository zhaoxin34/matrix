...
import type { OrgUnit, OrgUnitCreate, OrgUnitTreeNode, OrgUnitUpdate } from '@/types/org'
  ...
  return (
    <Modal
      ...
      footer={[
        ...
        <Button key="confirm" type="primary" onClick={handleOk} data-testid="btn-org-confirm">
          确认
        </Button>,
      ]}
    >
      <Form form={form} layout="vertical" style={{ marginTop: 16 }}>
        ...
        {mode === 'create' && (
          <Form.Item name="type" label="类型" rules={[{ required: true, message: '请选择类型' }]}>
            <Select options={ORG_TYPE_OPTIONS} placeholder="请选择组织类型" data-testid="sel-org-type" />
          </Form.Item>
        )}
        <Form.Item name="sort_order" label="排序">
          <InputNumber min={0} style={{ width: '100%' }} placeholder="0" data-testid="inp-org-sort" />
        </Form.Item>
      </Form>
    </Modal>
  )
