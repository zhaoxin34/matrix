...
export function EmployeeTable({
  ...
  const handleConfirmOnboarding = async (emp: Employee) => {
    try {
      await employeeApi.confirmOnboarding(emp.id);
      message.success("已确认入职");
      loadEmployees();
    } catch {
      message.error("确认入职失败");
    }
  };
        ...
        <Space size="small">
            ...
            <Tooltip title={emp.primary_unit_id === null ? "该员工尚未分配部门" : "确认入职"}>
              ...
              >
                <Button
                  ...
                  disabled={emp.primary_unit_id === null}
                  data-testid="btn-confirm-onboarding"
                />
              </Popconfirm>
            </Tooltip>
          )}
          {emp.user_mapping ? (
            <Tooltip title="解绑账号">
              <Popconfirm
                title="确认解绑账号？"
                onConfirm={() => handleUnbindUser(emp)}
              >
                <Button
                  type="link"
                  size="small"
    ...
    <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
          ...
          >
            <Button icon={<UploadOutlined />} data-testid="btn-employee-import">
              导入
            </Button>
          </Upload>
          <Button
            ...
            data-testid="btn-employee-export"
          >
            导出
          </Button>
          <Button
