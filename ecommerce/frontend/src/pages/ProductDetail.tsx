                  ...
                  <Col span={6} key={idx}>
                    <div
                      ...
                      style={{
                        cursor: 'pointer',
                        border:
                          currentImageIndex === idx ? '2px solid #1890ff' : '1px solid #d9d9d9',
                        borderRadius: 4,
                        overflow: 'hidden',
                        height: 80,
                        display: 'flex',
          ...
          <div>
            ...
            <Card size="small" style={{ marginBottom: 24, background: '#fafafa' }}>
              ...
              <div style={{ marginTop: 8 }}>
                <Badge
                  status={isInStock ? 'success' : 'error'}
                  text={isInStock ? `有货 (${product.stock}件)` : '缺货'}
                />
                      ...
                      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                        {options.map((opt) => (
                          <Button
                            ...
                            onClick={() =>
                              setSelectedVariant((v) => ({ ...v, [variantName]: opt }))
                            }
                          >
                            {opt}
                          </Button>
