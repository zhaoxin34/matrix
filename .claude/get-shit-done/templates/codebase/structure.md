...
- Usage: Reference from command with `@/Volumes/data/working/ai/matrix/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Volumes/data/working/ai/matrix/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Volumes/data/working/ai/matrix/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
