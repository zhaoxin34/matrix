...
Reference full template: `/Volumes/data/working/ai/matrix/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Volumes/data/working/ai/matrix/.claude/get-shit-done/templates/state.md`.
