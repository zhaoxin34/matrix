...
<required_reading>
@/Volumes/data/working/ai/matrix/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Volumes/data/working/ai/matrix/.claude
                  → checks /Volumes/data/working/ai/matrix/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Volumes/data/working/ai/matrix/.claude/get-shit-done
                  → writes to /Volumes/data/working/ai/matrix/.claude/get-shit-done/hooks/
...
@/Volumes/data/working/ai/matrix/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Volumes/data/working/ai/matrix/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
node "/Volumes/data/working/ai/matrix/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Volumes/data/working/ai/matrix/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
