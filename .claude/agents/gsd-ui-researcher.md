...
Use template from `/Volumes/data/working/ai/matrix/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Volumes/data/working/ai/matrix/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Volumes/data/working/ai/matrix/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
