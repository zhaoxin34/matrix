...
<reference>
@/Volumes/data/working/ai/matrix/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Volumes/data/working/ai/matrix/.claude/get-shit-done/references/user-profiling.md` to load:
