...
<execution_context>
@/Volumes/data/working/ai/matrix/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/Volumes/data/working/ai/matrix/.claude/get-shit-done/workflows/manager.md end-to-end.
