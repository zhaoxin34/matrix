...
<execution_context>
@/Volumes/data/working/ai/matrix/.claude/get-shit-done/workflows/autonomous.md
...
<process>
Execute the autonomous workflow from @/Volumes/data/working/ai/matrix/.claude/get-shit-done/workflows/autonomous.md end-to-end.
