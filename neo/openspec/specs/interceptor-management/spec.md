...
TBD — CRUD and lifecycle management for workspace-scoped interceptors, including the extension query API used by the Chrome Extension to load enabled rules for a given embedded site.
