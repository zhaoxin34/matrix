...
| 文件路径 | 页面 URL | 标题 |
| ---- | --------- | ------------ |
| `./admin/org-management技术设计.md` | `/docs/technical/admin/org-management` | 组织管理技术设计 |
| `./admin/user-management技术设计.md` | `/docs/technical/admin/user-management` | 用户管理技术设计 |
...
| `./agents/agent-embedded.md` | `/docs/technical/agents/agent-embedded` | Agent 嵌入技术设计文档 |
