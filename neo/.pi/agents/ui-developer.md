...
**工作空间**: `/Volumes/data/working/ai/matrix/neo/ui`
...
- **产品设计文档**: `./design/docs/product/` 目录下
  ...
  - `workspace设计.md` - Workspace 产品设计
  - `agent任务系统设计.md` - Agent 任务系统设计
  - `agent嵌入.md` - Agent 嵌入设计
  - `layout设计.md` - 布局设计
  - `组织管理设计.md` - 组织管理设计
  - `用户管理设计.md` - 用户管理设计
- **技术设计文档**: `./design/docs/technical/` 目录下
  - `workspace技术设计.md` - Workspace 技术设计
  - `org-management技术设计.md` - 组织管理技术设计
  - `user-management技术设计.md` - 用户管理技术设计
