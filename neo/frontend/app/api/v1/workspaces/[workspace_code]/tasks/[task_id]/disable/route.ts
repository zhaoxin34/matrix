/**
 * Disable Task API Proxy
 * POST /api/v1/workspaces/{workspace_code}/tasks/{task_id}/disable
 */
...
export async function POST(request: NextRequest) {
  ...
  const url = `${API_BASE_URL}/api/v1/workspaces/${workspaceCode}/tasks/${taskId}/disable`;
