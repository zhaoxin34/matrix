			...
			<Card>
				<CardHeader>
					<CardTitle className="flex items-center gap-2">
						<span className="font-mono text-lg">{status.entity_name}</span>
				...
				<CardContent className="space-y-6">
					...
					<div className="grid grid-cols-2 gap-4">
						<div className="space-y-1">
							<span className="text-xs text-muted-foreground">实体名称</span>
							<p className="font-mono text-sm">{status.entity_name}</p>
						</div>
						<div className="space-y-1">
