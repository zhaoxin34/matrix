...
function useWorkspaceMenuItems(): { items: MenuItem[]; showPrompt: boolean } {
  ...
  return {
    items: [
      ...
      {
        title: "录像管理",
        url: `/workspace/${currentWorkspace.code}/recordings`,
        icon: Video,
      },
      {
      ...
      {
        title: "事件",
        url: `/workspace/${currentWorkspace.code}/events`,
        icon: Activity,
      },
      {
        title: "状态",
        url: `/workspace/${currentWorkspace.code}/status`,
        icon: Database,
      },
      {
        title: "拦截器",
        url: `/workspace/${currentWorkspace.code}/interceptors`,
        icon: Layers,
      },
    ],
    showPrompt: false,
