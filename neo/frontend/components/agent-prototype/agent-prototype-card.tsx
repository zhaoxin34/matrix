...
import { DeletePrototypeDialog } from "./delete-dialog";
            ...
            <div className="flex items-center gap-1 pt-2 border-t">
              ...
              {prototype.status === "enabled" && (
                <>
                  ...
                  <Button variant="ghost" size="sm" asChild>
                    <Link
                      href={`/admin/agent-prototype/${prototype.id}?action=disable`}
                    >
                      <HugeiconsIcon
                        icon={PauseIcon}
                        strokeWidth={1.5}
                  ...
                  <Button variant="ghost" size="sm" asChild>
                    <Link
                      href={`/admin/agent-prototype/${prototype.id}?action=versions`}
                    >
                      <HugeiconsIcon
                        icon={Clock01Icon}
                        strokeWidth={1.5}
              ...
              {prototype.status === "disabled" && (
                <>
                  <Button variant="ghost" size="sm" asChild>
                    <Link
                      href={`/admin/agent-prototype/${prototype.id}?action=enable`}
                    >
                      <HugeiconsIcon
                        icon={PlayIcon}
                        strokeWidth={1.5}
