"""
Neo E2E Test Framework - Root Configuration
"""
...
BASE_URL = os.getenv("PLAYWRIGHT_BASE_URL", "http://localhost:3300")
...
def db_backup():
    ...
    def restore_and_cleanup():
        ...
        if _backup_file_path and Path(_backup_file_path).exists():
            ...
            console.print(
                "[green]Database restored and backup file cleaned up.[/green]"
            )
