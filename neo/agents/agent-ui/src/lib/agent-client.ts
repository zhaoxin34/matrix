// Client-side helper for POST /api/agent/[id] on the backend.
//
...
//
// NOTE: This now goes through apiUrl() so the request honors
// NEXT_PUBLIC_API_URL (the frontend talks to a separate backend process).
